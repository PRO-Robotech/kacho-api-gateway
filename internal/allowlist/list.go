...
var AllowedMethods = map[string]struct{}{
	...
	// RBAC rules-model F clean-cut: target/selector RPCs removed from proto
	// (AddTargetResources / RemoveTargetResources / ReplaceTargetSelector /
	// ListGrantableResources) — no longer routed; ListByResource renamed →
