...
// authz middleware (KAC-127 Phase 3).
//
// The api-gateway already exposes Prometheus textfile (KAC-30 baseline) by
// scraping a small set of process-level counters. We add three families:
//
