...
// the 60s `iat` freshness check; full shared-state replay protection is
// scope of Phase 10 (CLAUDE.md запрет #7 forbids Redis broker introduction
// before in-process suffices).
//
