...
//
// Used by:
//   - Backend M2M clients (Class A service accounts) provisioned with a static
//     client certificate + Hydra client_credentials grant; Hydra binds the
//     issued token to the cert thumbprint.
//
// Note: SPIFFE SVID is the long-term replacement (Phase 10 mesh integration);
// for Phase 2 we support both shapes via the same RFC 8705 mechanism.
package middleware
