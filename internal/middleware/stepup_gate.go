...
//
// ACR ordering (from acceptance §2.1, design §5.3):
//
...
// forcing a re-auth (matches the design doc's `mfa_fresh_until` concept).
package middleware
...
// permission catalog (Phase 1 artifact); a missing entry implies the default
