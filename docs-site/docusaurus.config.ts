...
const config: Config = {
  title: 'Kachō API Gateway',
  tagline: 'Edge контрол-плейна — единый gRPC + REST вход, AuthN/AuthZ и маршрутизация в домены',

  url: 'https://api-gateway.kacho.cloud',
  baseUrl: '/',
  onBrokenLinks: 'throw',

  organizationName: 'PRO-Robotech',
  projectName: 'kacho-api-gateway',
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/PRO-Robotech/kacho-api-gateway',
          label: 'GitHub',
          position: 'right',
        },
      ],
