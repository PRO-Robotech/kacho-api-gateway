// mtls_testcerts_test.go — SEC-E ephemeral test-CA + cert generation for the
...
//
// Mirrors kacho-corelib/grpcsrv/testcerts_test.go (SEC-B) so the gateway side
// dials against the same mTLS contract.
package main
